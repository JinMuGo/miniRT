...
/*   Updated: 2023/06/08 15:46:54 by sanghwal         ###   ########seoul.kr  */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	printf("===camera===\n");
	printf("type: %d, point: %f, %f, %f, vec: %f, %f, %f, fov: %f\n", meta->camera.view_point.x, meta->camera.view_point.y, meta->camera.view_point.z, meta->camera.normal_vec3.x, meta->camera.normal_vec3.y, meta->camera.normal_vec3.z, meta->camera.fov);
	return (0);
}
